...
public class HashMapDemo2 {
	...
	public static void main(String[] args) {
		...
		System.out.println("KeySet:" + language.keySet());// It will return set of keys

		System.out.println("values" + language.values());// It will return set of values

		System.out.println("Key/value set:" + language.entrySet());// entrySet() will return set of keys/values
		 ...
		 * 
		 * //add elements to hashmap language2.put(4, "Ruby");//1-entry language2.put(5,
		 * "C#");//2-entry language2.put(6, "HTML");//3-entry - change javascript to C++
		...
		/*
		 * for(int i: language.keySet()) { System.out.println(i);
		 * 
		 * }
		 */
		...
		/*
		 * for(String val: language.values()) { System.out.println(val);
		 * 
		 * }
		 */
